<template>
  <article class="markdown-body">
    <h1 class="atx" id="evms-tool-「以太坊虚拟机交互工具」-🔧">
      EVMs Tool 「以太坊虚拟机交互工具」 🔧
    </h1>
    <blockquote>
      <p>支持所有兼容EVM(以太坊虚拟机)的主网</p>
    </blockquote>
    <h2 class="atx" id="功能">功能</h2>
    <ul>
      <li>
        代币转账
        <ul>
          ...
          <li>
            <blockquote>
              <p>多转一</p>
              <p>
                前置条件: 导入<strong><u>多钱包查询</u></strong
                >生成的文件
              </p>
            </blockquote>
          </li>
      ...
      <li>
        <blockquote>
          <p>高级调用</p>
          <p>通过利用智能合约的ABI来调用指定的合约函数</p>
        </blockquote>
      </li>
    </ul>
    <h2 class="atx" id="如果对你有帮助-可以请我喝一杯咖啡☕️">
      如果对你有帮助, 可以请我喝一杯咖啡☕️
    </h2>
